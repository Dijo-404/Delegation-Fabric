...
AGENT_DIR = Path(__file__).resolve().parents[3] / "apps" / "agents" / "procurement_exception"
MANIFEST_MODULE = "apps.agents.procurement_exception.manifest"
TOOLS_MODULE = "apps.agents.procurement_exception.tools"
